...
class CrimeCctvModelOld(object):
    ...
    def sum_population_model(self) -> object:
        p_model = self.create_population_model()
        p_model['한국인'] = p_model['한국인'] - p_model['고령자']
        p_model['특별 인구'] = p_model['고령자'] + p_model['외국인']
        self.dfp.dframe(p_model)
        return p_model
